...
class CameraInterface : public QObject {
  ...
  public:
    ...
    explicit CameraInterface(CameraType cameraType,
  ...
  public slots:
    virtual void settingChangedSlot(const QString &name,
                                    ...
                                    const QString &val, bool update) = 0;
  ...
  protected:
    ...
    RootNode *m_cameraSettingsRootNode; // not sure if needed, might be enough
                                        // to have settingsObject
  ...
  protected slots:
    ...
    void statusInitFailed() {
        emit statusUpdated(Error, "Camera Initialisation Failed!");
    };
};
